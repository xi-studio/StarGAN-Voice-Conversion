...
def test(config):
    ...
    G = Generator(num_speakers=8).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_converted_wavs', type=int, default=100, help='number of wavs to convert.')
    ...
    parser.add_argument('--test_data_dir', type=str, default='./data/song/train')
